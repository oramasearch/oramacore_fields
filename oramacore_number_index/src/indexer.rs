...
/// Extracts numeric values from JSON for indexing in a [`NumberStorage`](crate::NumberStorage).
///
/// Supports two modes:
...
///
/// ```ignore
/// use oramacore_number_index::NumberIndexer;
/// use serde_json::json;
///
/// // Plain scalar field
...
///
/// - `Plain(T)`: A single value. Passed to [`NumberStorage::update`](crate::NumberStorage::update),
